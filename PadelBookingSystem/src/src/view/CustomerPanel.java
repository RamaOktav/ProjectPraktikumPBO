...
public class CustomerPanel extends JPanel {
    ...
    int result = controller.addCustomer(
        txtName.getText(), txtPhone.getText(), txtEmail.getText());

    switch (result) {
        case  1 -> { JOptionPane.showMessageDialog(this, "Pelanggan berhasil ditambahkan!"); clearForm(); loadData(); }
        case  0 -> JOptionPane.showMessageDialog(this, "Email sudah digunakan!", "Error", JOptionPane.ERROR_MESSAGE);
        case -1 -> JOptionPane.showMessageDialog(this, "Nama tidak boleh kosong!", "Error", JOptionPane.ERROR_MESSAGE);
    }
});

btnUpdate.addActionListener(e -> {
    if (selectedId < 0) { JOptionPane.showMessageDialog(this, "Pilih data dulu!"); return; }
    int result = controller.updateCustomer(
        selectedId, txtName.getText(), txtPhone.getText(), txtEmail.getText());

    switch (result) {
        case  1 -> { JOptionPane.showMessageDialog(this, "Data berhasil diupdate!"); clearForm(); loadData(); }
        case  0 -> JOptionPane.showMessageDialog(this, "Email sudah digunakan!", "Error", JOptionPane.ERROR_MESSAGE);
        case -1 -> JOptionPane.showMessageDialog(this, "Nama tidak boleh kosong!", "Error", JOptionPane.ERROR_MESSAGE);
    }
});
